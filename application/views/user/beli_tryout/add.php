...
<div class="form-group">
    ...
    <select name="id_tryout" class="form-control col-md-6">
        <option value="">-- Pilih Tryout --</option>
        <?php foreach($tryout as $data) : ?>
            <option value="<?php echo $data['id_tryout'] ?>"><?php echo $data['nama_tryout'] ?></option>
        <?php endforeach; ?>
    </select>
</div>
...
<div class="form-group">
    ...
    <select name="jenis_pembelian" class="form-control col-md-6">
