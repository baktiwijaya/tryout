...
echo form_open_multipart('admin/role/update', $form_attribute, $hidden_form);
?>
<div class="form-group">
    <label>Role</label>
    <?php $user_type = array('name' => 'user_type', 'maxlength' => '30', 'size' => '40', 'class' => 'form-control col-md-12', 'value' => $detail->user_type); ?>
    <?= form_input($user_type); ?>
</div>
<div class="form-group">
    <label></label>
