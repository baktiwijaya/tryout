...
class Kuantitatif extends CI_Controller {
    ...
    protected $user_type; 
    private $_kategori = 4;
    private $_kategori_soal = 'Pengetahuan Kuantitatif';
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/kuantitatif/load_table';
        $data['add'] = 'admin/kuantitatif/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/kuantitatif/edit';
        $data['index_jawaban'] = 'admin/kuantitatif/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/kuantitatif/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/kuantitatif/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/kuantitatif/load_jawaban';
        $data['add_jawaban'] = 'admin/kuantitatif/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/kuantitatif/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/kuantitatif/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/kuantitatif/update_jawaban';
