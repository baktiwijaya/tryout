...
class Kimia extends CI_Controller {
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/kimia/load_table';
        $data['add'] = 'admin/kimia/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/kimia/edit';
        $data['index_jawaban'] = 'admin/kimia/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/kimia/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/kimia/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/kimia/load_jawaban';
        $data['add_jawaban'] = 'admin/kimia/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/kimia/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/kimia/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/kimia/update_jawaban';
