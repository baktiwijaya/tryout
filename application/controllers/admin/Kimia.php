...
class Kimia extends CI_Controller {
    ...
    protected $user_type; 
    private $_kategori = 7;
    private $_kategori_soal = 'kimia dan Pemahamam Umum';
    ...
    public function index() {
        ...
        $data['content'] = 'admin/kimia/index';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/kimia/table', $data);
    }

    public function add() {
        $this->load->view('admin/kimia/add');
    }
    ...
    public function edit() {
        ...
        $this->load->view('admin/kimia/edit', $data);
    }
    ...
    public function edit_jawaban() {
        ...
        $this->load->view('admin/kimia/edit_jawaban', $data);
    }
