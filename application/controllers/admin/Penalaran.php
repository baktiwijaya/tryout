...
class Penalaran extends CI_Controller {
    ...
    public function index() {
        ...
        $data['content'] = 'admin/penalaran/index';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/penalaran/table', $data);
    }

    public function add() {
        $this->load->view('admin/penalaran/add');
    }
    ...
    public function edit() {
        ...
        $this->load->view('admin/penalaran/edit', $data);
    }
    ...
    public function edit_jawaban() {
        ...
        $this->load->view('admin/penalaran/edit_jawaban', $data);
    }
