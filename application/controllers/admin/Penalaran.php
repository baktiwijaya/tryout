...
class Penalaran extends CI_Controller {

    protected $user_type; 
    private $_kategori = 1;
    private $_kategori_soal = 'Penalaran Umum';
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/penalaran/load_table';
        $data['add'] = 'admin/penalaran/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/penalaran/edit';
        $data['index_jawaban'] = 'admin/penalaran/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/penalaran/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/penalaran/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/penalaran/load_jawaban';
        $data['add_jawaban'] = 'admin/penalaran/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/penalaran/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/penalaran/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/penalaran/update_jawaban';
