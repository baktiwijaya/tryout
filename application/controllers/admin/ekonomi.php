...
class Ekonomi extends CI_Controller {
    ...
    public function index() {
        ...
        $data['content'] = 'admin/ekonomi/index';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/ekonomi/table', $data);
    }

    public function add() {
        $this->load->view('admin/ekonomi/add');
    }
    ...
    public function edit() {
        ...
        $this->load->view('admin/ekonomi/edit', $data);
    }
    ...
    public function edit_jawaban() {
        ...
        $this->load->view('admin/ekonomi/edit_jawaban', $data);
    }
