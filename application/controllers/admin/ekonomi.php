...
class Ekonomi extends CI_Controller {
    ...
    protected $user_type; 
    private $_kategori = 10;
    private $_kategori_soal = 'Ekonomi';
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/ekonomi/load_table';
        $data['add'] = 'admin/ekonomi/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/ekonomi/edit';
        $data['index_jawaban'] = 'admin/ekonomi/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/ekonomi/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/ekonomi/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/ekonomi/load_jawaban';
        $data['add_jawaban'] = 'admin/ekonomi/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/ekonomi/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/ekonomi/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/ekonomi/update_jawaban';
