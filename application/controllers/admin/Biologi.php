...
class Biologi extends CI_Controller {
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/biologi/load_table';
        $data['add'] = 'admin/biologi/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/biologi/edit';
        $data['index_jawaban'] = 'admin/biologi/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/biologi/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/biologi/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/biologi/load_jawaban';
        $data['add_jawaban'] = 'admin/biologi/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/biologi/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/biologi/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/biologi/update_jawaban';
