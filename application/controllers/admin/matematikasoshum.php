...
class matematikasoshum extends CI_Controller {
    ...
    protected $user_type; 
    private $_kategori = 9;
    private $_kategori_soal = 'matematikasoshum';
    ...
    public function index() {
        ...
        $data['content'] = 'admin/matematikasoshum/index';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/matematikasoshum/table', $data);
    }

    public function add() {
        $this->load->view('admin/matematikasoshum/add');
    }
    ...
    public function edit() {
        ...
        $this->load->view('admin/matematikasoshum/edit', $data);
    }
    ...
    public function index_jawaban() {
        ...
        $this->load->view('admin/matematikasoshum/index_jawaban', $data);
    }

    public function load_jawaban() {
        extract($_POST);
        $data['list'] = $this->Crud_m->all_data('master_jawaban','*',"id_soal=$id");
        $this->load->view('admin/matematikasoshum/table_jawaban', $data);
    }

    public function add_jawaban() {
        extract($_POST);
        $data['id_soal'] = $this->session->userdata('id_soal');
        $this->load->view('admin/matematikasoshum/add_jawaban',$data);
    }
    ...
    public function edit_jawaban() {
        ...
        $this->load->view('admin/matematikasoshum/edit_jawaban', $data);
    }
