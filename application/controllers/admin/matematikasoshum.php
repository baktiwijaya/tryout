...
class Matematikasoshum extends CI_Controller {

    protected $user_type; 
    private $_kategori = 9;
    private $_kategori_soal = 'Matematika Soshum';
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/matematikasoshum/load_table';
        $data['add'] = 'admin/matematikasoshum/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/matematikasoshum/edit';
        $data['index_jawaban'] = 'admin/matematikasoshum/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/matematikasoshum/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/matematikasoshum/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/matematikasoshum/load_jawaban';
        $data['add_jawaban'] = 'admin/matematikasoshum/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/matematikasoshum/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/matematikasoshum/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/matematikasoshum/update_jawaban';
