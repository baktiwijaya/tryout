...
class Geografi extends CI_Controller {
    ...
    protected $user_type; 
    private $_kategori = 11;
    private $_kategori_soal = 'Geografi';
    ...
    public function index() {
        ...
        $data['load_table'] = 'admin/geografi/load_table';
        $data['add'] = 'admin/geografi/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/geografi/edit';
        $data['index_jawaban'] = 'admin/geografi/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/geografi/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/geografi/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/geografi/load_jawaban';
        $data['add_jawaban'] = 'admin/geografi/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/geografi/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/geografi/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/geografi/update_jawaban';
