...
class Geografi extends CI_Controller {
    ...
    public function index() {
        ...
        $data['content'] = 'admin/geografi/index';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/geografi/table', $data);
    }

    public function add() {
        $this->load->view('admin/geografi/add');
    }
    ...
    public function edit() {
        ...
        $this->load->view('admin/geografi/edit', $data);
    }
    ...
    public function edit_jawaban() {
        ...
        $this->load->view('admin/geografi/edit_jawaban', $data);
    }
