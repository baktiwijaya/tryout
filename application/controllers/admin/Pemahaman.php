...
class Pemahaman extends CI_Controller {
    ...
    public function index() {
        $data['menu'] = 'Soal';
        $data['smenu'] = 'Pemahaman Baca dan Menulis';
        $data['title'] = 'Master Soal'." ".$this->_kategori_soal;
        $data['content'] = 'admin/master_soal/index';
        $data['load_table'] = 'admin/pemahaman/load_table';
        $data['add'] = 'admin/pemahaman/add';
        $this->load->view('admin/template/main', $data);
    }

    public function load_table() {
        $data['edit'] = 'admin/pemahaman/edit';
        $data['index_jawaban'] = 'admin/pemahaman/index_jawaban';
        $data['list'] = $this->Crud_m->all_data('master_soal', '*','kategori='.$this->_kategori);
        $this->load->view('admin/master_soal/table', $data);
    }

    public function add() {
        $data['form_action'] = 'admin/pemahaman/save';
    ...
    public function edit() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/pemahaman/update';
    ...
    public function index_jawaban() {
        ...
        $data['load_jawaban'] = 'admin/pemahaman/load_jawaban';
        $data['add_jawaban'] = 'admin/pemahaman/add_jawaban';
    ...
    public function load_jawaban() {
        extract($_POST);
        $data['edit_jawaban'] = 'admin/pemahaman/edit_jawaban';
    ...
    public function add_jawaban() {
        extract($_POST);
        $data['form_action'] = 'admin/pemahaman/save_jawaban';
    ...
    public function edit_jawaban() {
        extract($_POST);
        $data['id'] = $id;
        $data['form_action'] = 'admin/pemahaman/update_jawaban';
